 ...
 * @since 5.2
 */
final class CustomOpenSamlImplementation {
    private static CustomOpenSamlImplementation instance = new CustomOpenSamlImplementation();
    ...
    private CustomOpenSamlImplementation() {
        bootstrap();
    }
     ...
     * ==============================================================
     */
    static CustomOpenSamlImplementation getInstance() {
        return instance;
    }
    ...
    Map<String, String> signQueryParameters(
        ...
        try {
            ...
            String b64Signature = CustomSaml2Utils.samlEncode(rawSignature);
