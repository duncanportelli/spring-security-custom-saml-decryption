package boot.saml2.config.overridden;
...
import boot.saml2.config.Decrypter;
 ...
 *
 * <p>
 *  The {@link org.springframework.security.saml2.provider.service.authentication.OpenSamlAuthenticationProvider} supports {@link Saml2AuthenticationToken} objects
 ...
 */
public final class CustomOpenSamlAuthenticationProvider implements AuthenticationProvider {

    private static Log logger = LogFactory.getLog(
        org.springframework.security.saml2.provider.service.authentication.OpenSamlAuthenticationProvider.class);

    private final CustomOpenSamlImplementation saml = CustomOpenSamlImplementation.getInstance();
